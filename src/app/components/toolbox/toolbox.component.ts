...
export class ToolboxComponent implements OnInit,OnDestroy {
  ...
  constructor(private toolsService:ToolsService,private cd:ChangeDetectorRef) { }
  ...
  ngOnInit() {
    ...
    this.toolsService.activeToolChanged().pipe(takeUntil(this.destroyed$)).subscribe(tool => {
